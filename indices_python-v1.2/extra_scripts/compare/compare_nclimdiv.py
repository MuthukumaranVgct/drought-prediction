...
if __name__ == '__main__':
    ...
    $ python -u compare_nclimdiv.py --out_file C:/home/data/nclimdiv/nclimdiv_latest.nc \
                                    --month_scales 1 2 3 6 9 12 24 \
                                    --calibration_start_year 1931 \
                                    --calibration_end_year 1990

    This module is used to perform climate indices processing and analysis on nClimDiv datasets.
    
    Ingests from ASCII to NetCDF.
    Processes indices from NetCDF input.
    Computes and stores differences compared to corresponding NCEI operational results.
